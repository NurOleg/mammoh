    ...
    <main class="main">
        <section class="contacts-page">
            <div class="container contacts-page__container">
                <h1 class="section-title contacts-page__section-title">Контакты</h1>
                <div class="contacts-page__grid">
                    ...
                    <div class="contacts-page__grid-right">
                        ...
                        <div class="contacts-page__map">
                            <iframe src="//yandex.ru/map-widget/v1/?um=constructor%3A5fcb734296503b59931d234a7cc6d83abfe323650314022679706ce1f87000b7&amp;source=constructor" width="100%" height="400" frameborder="0"></iframe>
                        </div>
                    </div>
                </div>
            </div>
